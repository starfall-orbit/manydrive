...
internal object AppLanguage {
    private val english = mapOf(
        ...
        "Hiển thị tệp ẩn" to "Show hidden files",
        "Hiển thị tệp và thư mục bắt đầu bằng dấu chấm trong Tệp Hệ Thống" to
            "Show files and folders beginning with a dot in System Files",
        "Chọn ổ đĩa" to "Choose storage",
        "Bộ nhớ dùng chung" to "Shared storage",
        "Thư mục ứng dụng" to "App folder",
        "Bộ nhớ ngoài" to "External storage",
        "Ổ lưu trữ" to "Storage volume",
